...
settings_list = [
    ['Content Services', [
        setting('Content Services', [''], content.services, 'active', entry="content service", subclass=True,
                ...
                help='Please choose at least one content service that plex_monitor should monitor for new content.'),
        ...
        setting('Trakt auto remove',
                ...
                help='By default, movies are removed from your watchlist after a successful download. In this setting you can choose to automatically remove shows, shows and movies or nothing.'),
        setting('Trakt early movie releases', 'Please enter "true" or "false": ', content.services.trakt, 'early_releases', help="plex_monitor can check for early releases of movies by checking trakt for 'latest releases' lists. You can turn this feature on or off.",hidden=True),
        setting('Overseerr users', ['Please choose a user: '], content.services.overseerr, 'users', entry="user",
                help="Please specify which users requests should be downloaded by plex_monitor.", hidden=True),
    ...
    ['Library Services', [
        ...
        setting('Plex library partial scan', 'Please enter "true" or "false": ', content.services.plex.library.refresh, 'partial', hidden=True, help="Specify wether or not plex_monitor should attempt to partially scan your plex libraries."),
        setting('Plex library refresh delay', 'Please enter a number (e.g 420 or 69.69): ', content.services.plex.library.refresh, 'delay', hidden=True, help="Specify the amount of seconds plex_monitor should wait between adding a torrent and scanning your plex libraries."),
    ...
    ['Arr Services', [
        ...
        setting('Sonarr Root Folder',
                ...
                help='Must match a root folder path already configured in Sonarr (Settings → Media Management → Root Folders)'),
        ...
        setting('Radarr Root Folder',
                ...
                help='Must match a root folder path already configured in Radarr (Settings → Media Management → Root Folders)'),
    ]
        ],
    ['UI Settings', [
